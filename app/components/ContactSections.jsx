...
const ContactSections = () => {
  return (
    <section className="max-w-screen-3xl mx-auto w-full h-screen relative px-8 py-6 md:py-8 lg:px-28 ">
      {/* Entire div */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-start gap-6 py-6 border-t border-primary_customGrey-700">
        ...
        <div className="flex flex-col justify-center items-center gap-6 w-full md:w-1/2 lg:w-1/3">
          {/* First item */}
          <div className="flex flex-col md:flex-row justify-start items-start gap-6 text-xl border-b border-primary_backgroundColor-600 py-4 w-full">
            <div>Phone</div>
            <div>065 887 999</div>
          </div>
          {/* Second item */}
